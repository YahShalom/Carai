...
// Reusing TechBadge logic locally
  ...
  return (
    <div className="min-h-screen pt-24 pb-20">
        ...
        <div className="absolute bottom-0 left-0 w-full p-6 md:p-12 relative z-10">
            <div className="max-w-7xl mx-auto">
                ...
                <p className="mt-4 text-xl text-silver-300 max-w-2xl font-light">
                    A collection of AI-driven applications and modern web interfaces designed to scale.
                </p>
            </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Filter Dropdown */}
        <div className="mb-12 relative z-20" ref={filterRef}>
        ...
        {/* Projects Grid */}
        <div className="grid grid-cols-1 gap-12 min-h-[500px]" key={filter}>
